...
//A class that handles all the methods related to DivHash
public class DivHash 
{
	...
	//Returns a hash code via the division method
	public int divHashFunction(Person person)
	{
	...
	public void register(Person person)
	{
		...
		int key = divHashFunction(person);
	...
	public void chainedHashDelete(Person original, Person friend)
	{
		...
		int key = divHashFunction(original);
	...
	public void checkTwoFriends(String one, String two)
	{
		...
		int key1 = divHashFunction(original);
		boolean done = false;
		...
		int key2 = divHashFunction(friend);
		boolean done2 = false;
	...
	public static void main(String[] args)
	{
		...
		d.chainedHashInsert(jen, pen);
		d.chainedHashInsert(pen, jen);
	
		d.checkTwoFriends("Jen", "Pen");
